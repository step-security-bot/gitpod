...
const (
	WorkspaceSortableField_WORKSPACE_SORTABLE_FIELD_UNSPECIFIED WorkspaceSortableField = 0
)

// Enum value maps for WorkspaceSortableField.
var (
	WorkspaceSortableField_name = map[int32]string{
		0: "WORKSPACE_SORTABLE_FIELD_UNSPECIFIED",
	}
...
type ListWorkspacesRequest_Scope int32

const (
	ListWorkspacesRequest_SCOPE_UNSPECIFIED ListWorkspacesRequest_Scope = 0
	// SCOPE_MY_WORKSPACES_IN_ORGANIZATION scopes workspaces that is owned by current user in the organization
	ListWorkspacesRequest_SCOPE_MY_WORKSPACES_IN_ORGANIZATION ListWorkspacesRequest_Scope = 1
	// SCOPE_ALL_WORKSPACES_IN_ORGANIZATION scopes all workspaces in the organization
	ListWorkspacesRequest_SCOPE_ALL_WORKSPACES_IN_ORGANIZATION ListWorkspacesRequest_Scope = 2
	// SCOPE_ALL_WORKSPACES_IN_INSTALLATION scopes all workspaces in the installation
	ListWorkspacesRequest_SCOPE_ALL_WORKSPACES_IN_INSTALLATION ListWorkspacesRequest_Scope = 3
)

// Enum value maps for ListWorkspacesRequest_Scope.
var (
	ListWorkspacesRequest_Scope_name = map[int32]string{
		0: "SCOPE_UNSPECIFIED",
		1: "SCOPE_MY_WORKSPACES_IN_ORGANIZATION",
		2: "SCOPE_ALL_WORKSPACES_IN_ORGANIZATION",
		3: "SCOPE_ALL_WORKSPACES_IN_INSTALLATION",
	}
	ListWorkspacesRequest_Scope_value = map[string]int32{
		"SCOPE_UNSPECIFIED":                    0,
...
func (x ListWorkspacesRequest_Scope) Enum() *ListWorkspacesRequest_Scope {
	p := new(ListWorkspacesRequest_Scope)
	*p = x
	return p
}

func (x ListWorkspacesRequest_Scope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ListWorkspacesRequest_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_gitpod_v1_workspace_proto_enumTypes[2].Descriptor()
}

func (ListWorkspacesRequest_Scope) Type() protoreflect.EnumType {
	return &file_gitpod_v1_workspace_proto_enumTypes[2]
}

func (x ListWorkspacesRequest_Scope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ListWorkspacesRequest_Scope.Descriptor instead.
func (ListWorkspacesRequest_Scope) EnumDescriptor() ([]byte, []int) {
	return file_gitpod_v1_workspace_proto_rawDescGZIP(), []int{4, 0}
}
...
func (WorkspacePort_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_gitpod_v1_workspace_proto_rawDescGZIP(), []int{10, 1}
}
...
type ListWorkspacesRequest struct {
	...
	Sorts      []*WorkspaceSortRequest `protobuf:"bytes,2,rep,name=sorts,proto3" json:"sorts,omitempty"`
	// scope of the workspaces
	Scope ListWorkspacesRequest_Scope `protobuf:"varint,3,opt,name=scope,proto3,enum=gitpod.v1.ListWorkspacesRequest_Scope" json:"scope,omitempty"`
...
func (x *ListWorkspacesRequest) GetSorts() []*WorkspaceSortRequest {
	if x != nil {
		return x.Sorts
	}
	return nil
...
func (x *ListWorkspacesRequest) GetScope() ListWorkspacesRequest_Scope {
	if x != nil {
		return x.Scope
	}
	return ListWorkspacesRequest_SCOPE_UNSPECIFIED
}
...
type WorkspaceSortRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Field WorkspaceSortableField `protobuf:"varint,1,opt,name=field,proto3,enum=gitpod.v1.WorkspaceSortableField" json:"field,omitempty"`
	Order SortOrder              `protobuf:"varint,2,opt,name=order,proto3,enum=gitpod.v1.SortOrder" json:"order,omitempty"`
}

func (x *WorkspaceSortRequest) Reset() {
	*x = WorkspaceSortRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceSortRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceSortRequest) ProtoMessage() {}

func (x *WorkspaceSortRequest) ProtoReflect() protoreflect.Message {
	mi := &file_gitpod_v1_workspace_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceSortRequest.ProtoReflect.Descriptor instead.
func (*WorkspaceSortRequest) Descriptor() ([]byte, []int) {
	return file_gitpod_v1_workspace_proto_rawDescGZIP(), []int{6}
}

func (x *WorkspaceSortRequest) GetField() WorkspaceSortableField {
	if x != nil {
		return x.Field
	}
	return WorkspaceSortableField_WORKSPACE_SORTABLE_FIELD_UNSPECIFIED
}

func (x *WorkspaceSortRequest) GetOrder() SortOrder {
	if x != nil {
		return x.Order
	}
...
var file_gitpod_v1_workspace_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x67, 0x69, 0x74, 0x70, 0x6f, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x73,
	0x6f, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x25, 0x0a, 0x13, 0x47, 0x65, 0x74,
	0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	0x22, 0x40, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65,
	...
	0x76, 0x31, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x04, 0x69, 0x74,
	0x65, 0x6d, 0x22, 0x56, 0x0a, 0x1b, 0x57, 0x61, 0x74, 0x63, 0x68, 0x57, 0x6f, 0x72, 0x6b, 0x73,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x77, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x22, 0x75, 0x0a, 0x1c, 0x57, 0x61,
	0x74, 0x63, 0x68, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x77, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x32, 0x0a,
	...
	0x73, 0x22, 0xca, 0x03, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x05, 0x73, 0x6f, 0x72,
	0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x67, 0x69, 0x74, 0x70, 0x6f,
	0x64, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x6f,
	0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x05, 0x73, 0x6f, 0x72, 0x74, 0x73,
	0x12, 0x3c, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x74, 0x2e, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x27,
	0x0a, 0x0f, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69,
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x69, 0x6e, 0x6e, 0x65,
	...
	,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x06, 0x70, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x12, 0x32, 0x0a, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x69, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x0a, 0x0e, 0x50, 0x52, 0x4f, 0x54, 0x4f, 0x43, 0x4f, 0x4c, 0x5f, 0x48, 0x54, 0x54, 0x50,
	0x53, 0x10, 0x02, 0x22, 0x8d, 0x03, 0x0a, 0x12, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x47, 0x69, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6c,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x75, 0x6e, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x65, 0x64, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f,
	...
	0x74, 0x65, 0x64, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	0x65, 0x64, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e,
	...
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x75, 0x6e,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x14, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x55, 0x6e, 0x70, 0x75, 0x73, 0x68, 0x65, 0x64, 0x43, 0x6f, 0x6d, 0x6d,
	0x69, 0x74, 0x73, 0x22, 0xef, 0x02, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x50, 0x68, 0x61, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	0x50, 0x45, 0x44, 0x10, 0x09, 0x22, 0x3f, 0x0a, 0x0f, 0x45, 0x64, 0x69, 0x74, 0x6f, 0x72, 0x52,
	0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76,
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x57, 0x0a, 0x1c, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	...
	0x42, 0x0a, 0x16, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x6f, 0x72, 0x74,
	0x61, 0x62, 0x6c, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x28, 0x0a, 0x24, 0x57, 0x4f, 0x52,
	0x4b, 0x53, 0x50, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x4f, 0x52, 0x54, 0x41, 0x42, 0x4c, 0x45, 0x5f,
	0x46, 0x49, 0x45, 0x4c, 0x44, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45,
	0x44, 0x10, 0x00, 0x2a, 0x6f, 0x0a, 0x0e, 0x41, 0x64, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x4e, 0x45, 0x10, 0x02, 0x32, 0xab, 0x02, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x57, 0x0a, 0x0e, 0x4c, 0x69, 0x73,
...
var file_gitpod_v1_workspace_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_gitpod_v1_workspace_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_gitpod_v1_workspace_proto_goTypes = []interface{}{
	(WorkspaceSortableField)(0),          // 0: gitpod.v1.WorkspaceSortableField
	(AdmissionLevel)(0),                  // 1: gitpod.v1.AdmissionLevel
	(ListWorkspacesRequest_Scope)(0),     // 2: gitpod.v1.ListWorkspacesRequest.Scope
	(WorkspacePort_Policy)(0),            // 3: gitpod.v1.WorkspacePort.Policy
	(WorkspacePort_Protocol)(0),          // 4: gitpod.v1.WorkspacePort.Protocol
	(WorkspacePhase_Phase)(0),            // 5: gitpod.v1.WorkspacePhase.Phase
	(*GetWorkspaceRequest)(nil),          // 6: gitpod.v1.GetWorkspaceRequest
	(*GetWorkspaceResponse)(nil),         // 7: gitpod.v1.GetWorkspaceResponse
	(*WatchWorkspaceStatusRequest)(nil),  // 8: gitpod.v1.WatchWorkspaceStatusRequest
	(*WatchWorkspaceStatusResponse)(nil), // 9: gitpod.v1.WatchWorkspaceStatusResponse
	(*ListWorkspacesRequest)(nil),        // 10: gitpod.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),       // 11: gitpod.v1.ListWorkspacesResponse
	(*WorkspaceSortRequest)(nil),         // 12: gitpod.v1.WorkspaceSortRequest
	(*Workspace)(nil),                    // 13: gitpod.v1.Workspace
	(*WorkspaceStatus)(nil),              // 14: gitpod.v1.WorkspaceStatus
	(*WorkspaceConditions)(nil),          // 15: gitpod.v1.WorkspaceConditions
	(*WorkspacePort)(nil),                // 16: gitpod.v1.WorkspacePort
	(*WorkspaceGitStatus)(nil),           // 17: gitpod.v1.WorkspaceGitStatus
	(*WorkspacePhase)(nil),               // 18: gitpod.v1.WorkspacePhase
	(*EditorReference)(nil),              // 19: gitpod.v1.EditorReference
	(*WorkspaceEnvironmentVariable)(nil), // 20: gitpod.v1.WorkspaceEnvironmentVariable
	(*PaginationRequest)(nil),            // 21: gitpod.v1.PaginationRequest
	(*PaginationResponse)(nil),           // 22: gitpod.v1.PaginationResponse
	(SortOrder)(0),                       // 23: gitpod.v1.SortOrder
	(*timestamppb.Timestamp)(nil),        // 24: google.protobuf.Timestamp
}
var file_gitpod_v1_workspace_proto_depIdxs = []int32{
	13, // 0: gitpod.v1.GetWorkspaceResponse.item:type_name -> gitpod.v1.Workspace
	14, // 1: gitpod.v1.WatchWorkspaceStatusResponse.status:type_name -> gitpod.v1.WorkspaceStatus
	21, // 2: gitpod.v1.ListWorkspacesRequest.pagination:type_name -> gitpod.v1.PaginationRequest
	12, // 3: gitpod.v1.ListWorkspacesRequest.sorts:type_name -> gitpod.v1.WorkspaceSortRequest
	2,  // 4: gitpod.v1.ListWorkspacesRequest.scope:type_name -> gitpod.v1.ListWorkspacesRequest.Scope
	13, // 5: gitpod.v1.ListWorkspacesResponse.workspaces:type_name -> gitpod.v1.Workspace
	22, // 6: gitpod.v1.ListWorkspacesResponse.pagination:type_name -> gitpod.v1.PaginationResponse
	0,  // 7: gitpod.v1.WorkspaceSortRequest.field:type_name -> gitpod.v1.WorkspaceSortableField
	23, // 8: gitpod.v1.WorkspaceSortRequest.order:type_name -> gitpod.v1.SortOrder
	14, // 9: gitpod.v1.Workspace.status:type_name -> gitpod.v1.WorkspaceStatus
	20, // 10: gitpod.v1.Workspace.additional_environment_variables:type_name -> gitpod.v1.WorkspaceEnvironmentVariable
	19, // 11: gitpod.v1.Workspace.editor:type_name -> gitpod.v1.EditorReference
	18, // 12: gitpod.v1.WorkspaceStatus.phase:type_name -> gitpod.v1.WorkspacePhase
	17, // 13: gitpod.v1.WorkspaceStatus.git_status:type_name -> gitpod.v1.WorkspaceGitStatus
	16, // 14: gitpod.v1.WorkspaceStatus.ports:type_name -> gitpod.v1.WorkspacePort
	1,  // 15: gitpod.v1.WorkspaceStatus.admission:type_name -> gitpod.v1.AdmissionLevel
	15, // 16: gitpod.v1.WorkspaceStatus.conditions:type_name -> gitpod.v1.WorkspaceConditions
	3,  // 17: gitpod.v1.WorkspacePort.policy:type_name -> gitpod.v1.WorkspacePort.Policy
	4,  // 18: gitpod.v1.WorkspacePort.protocol:type_name -> gitpod.v1.WorkspacePort.Protocol
	5,  // 19: gitpod.v1.WorkspacePhase.name:type_name -> gitpod.v1.WorkspacePhase.Phase
	24, // 20: gitpod.v1.WorkspacePhase.last_transition_time:type_name -> google.protobuf.Timestamp
	6,  // 21: gitpod.v1.WorkspaceService.GetWorkspace:input_type -> gitpod.v1.GetWorkspaceRequest
	8,  // 22: gitpod.v1.WorkspaceService.WatchWorkspaceStatus:input_type -> gitpod.v1.WatchWorkspaceStatusRequest
	10, // 23: gitpod.v1.WorkspaceService.ListWorkspaces:input_type -> gitpod.v1.ListWorkspacesRequest
	7,  // 24: gitpod.v1.WorkspaceService.GetWorkspace:output_type -> gitpod.v1.GetWorkspaceResponse
	9,  // 25: gitpod.v1.WorkspaceService.WatchWorkspaceStatus:output_type -> gitpod.v1.WatchWorkspaceStatusResponse
	11, // 26: gitpod.v1.WorkspaceService.ListWorkspaces:output_type -> gitpod.v1.ListWorkspacesResponse
...
func file_gitpod_v1_workspace_proto_init() {
	...
	file_gitpod_v1_sort_proto_init()
	if !protoimpl.UnsafeEnabled {
		...
		file_gitpod_v1_workspace_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceSortRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gitpod_v1_workspace_proto_msgTypes[7].OneofWrappers = []interface{}{}
	...
	file_gitpod_v1_workspace_proto_msgTypes[14].OneofWrappers = []interface{}{}
	type x struct{}
